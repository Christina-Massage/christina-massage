  ...
  const content = useMemo(() => {
    const de = {
      ...
      booking: {
        ...
        text:
          "Wähle im Buchungskalender zuerst deinen gewünschten Tag und danach eine freie Uhrzeit, Behandlung und Dauer. Vor der Buchung ist eine Registrierung erforderlich.",
        button: "Zum Kalender",
      },
      location: {
        eyebrow: "Anfahrt",
    ...
    const hu = {
      ...
      booking: {
        ...
        text:
          "A foglalási naptárban először válaszd ki a napot, majd a szabad időpontot, a kezelést és az időtartamot. A foglaláshoz regisztráció szükséges.",
          ...
          sections: [
            {
              ...
              paragraphs: [
                "Die schwedische Massage ist eine der bekanntesten und am weitesten verbreiteten Massageformen. Sie dient vor allem der Entspannung, Lockerung der Muskulatur und Förderung des allgemeinen Wohlbefindens.",
                "Durch die Kombination aus sanften und kräftigeren Grifftechniken wird der gesamte Körper harmonisiert und revitalisiert.",
              ],
            },
            {
              ...
              bullets: [
                ...
                "Stressabbau und seelische Entspannung",
            ...
            },
            {
              ...
              bullets: [
                ...
                "Offene Wunden oder starke Hauterkrankungen",
          ...
          sections: [
            {
              ...
              paragraphs: [
                ...
                "Durch langes Sitzen, Stress, wiederkehrende Belastungen oder körperliche Überanstrengung entstehen häufig Muskelverhärtungen im Nacken-, Schulter- und Rückenbereich.",
              ],
            },
                        {
          ...
          sections: [
            {
              heading: "Allgemeine Beschreibung",
              paragraphs: [
                "Die Fußmassage ist eine beruhigende und therapeutische Behandlung, die sich auf die Entspannung und Aktivierung der Füße konzentriert.",
                "Gezielte Massagetechniken lösen Spannungen, regen die Durchblutung an und verbessern das allgemeine Wohlbefinden.",
              ],
            },
            {
              heading: "Ziele der Fußmassage",
              bullets: [
                "Anregung der Durchblutung in den Füßen",
                "Linderung von Muskelverspannungen",
                "Entspannung von Körper und Geist",
                "Entlastung müder und schwerer Beine",
                "Unterstützung der Regeneration nach körperlicher Belastung",
            ...
            },
            {
              ...
              bullets: [
                ...
                "60 Minuten – umfassende Behandlung, optional mit Fußbad",
              ],
            },
            {
              heading: "Kontraindikationen",
              bullets: [
                "Offene Wunden oder Hauterkrankungen am Fuß",
                "Akute Entzündungen oder Infektionen",
                "Frische Verletzungen oder Operationen",
                "Thrombose oder schwere Gefäßerkrankungen",
          ...
          sections: [
            {
              heading: "Allgemeine Beschreibung",
              paragraphs: [
                "Die Champi Kopfmassage, auch bekannt als indische Kopfmassage, ist eine traditionelle Behandlung mit Ursprung in der indischen Ayurveda-Heilkunst.",
                "Diese Massage konzentriert sich auf Kopf, Nacken, Schultern und Gesicht und zielt auf die Harmonisierung von Körper und Geist ab.",
              ],
            },
            {
              ...
              bullets: [
                ...
                "Linderung spannungsbedingter Kopfschmerzen",
          ...
          sections: [
            {
              ...
              paragraphs: [
                ...
                "Die Behandlung nutzt den gezielten Druck eines speziellen elastischen Bandes, das über mechanische und physiologische Mechanismen positive Wirkungen entfalten kann.",
              ],
            },
          ],
        },
          ...
          sections: [
            {
              ...
              paragraphs: [
                ...
                "Dieser Sog fördert die lokale Blut- und Lymphzirkulation, löst Muskelverhärtungen und lockert verklebtes Bindegewebe.",
              ],
            },
          ],
        },
          ...
          sections: [
            {
              ...
              paragraphs: [
                ...
                "Ez a szívóhatás fokozza a helyi vér- és nyirokkeringést, oldja az izomcsomókat, lazítja a letapadt kötőszövetet.",
              ],
            },
          ],
        },
          ...
          sections: [
            {
              ...
              paragraphs: [
                ...
                "Ziel ist die Lösung von Spannungen und Verklebungen sowie die Verbesserung von Beweglichkeit und Gewebequalität.",
              ],
            },
          ],
        },
          ...
          sections: [
            {
              heading: "Általános leírás",
              paragraphs: [
                "A hegkezelés a hegszövet esztétikai és funkcionális javítását célzó eljárások összessége, amely magában foglalja a manuális technikákat.",
      ...
      <header className="sticky top-0 z-50 border-b border-[#6f7d58] bg-[#7a8662]/95 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 lg:px-10">
          ...
          <div className="hidden items-center gap-4 text-base text-white lg:flex">
            ...
            <a
              href="/booking?auth=1"
              className="rounded-full border border-white/70 px-5 py-2 text-base font-medium text-white hover:bg-white/10"
            >
              {c.nav.login}
            </a>
            <a
