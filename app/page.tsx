  ...
  const content = useMemo(() => {
    const de = {
      ...
      about: {
        ...
        qualificationsTitle: "Mein beruflicher Werdegang und meine Qualifikationen",
        qualificationsText: [
      ...
      methods: {
        ...
        cards: [
          ...
          },
          {
            title: "Flossing",
            text:
              "Flossing ist eine moderne physiotherapeutische Behandlung, die gezielt auf Faszien, Muskeln und Gelenke wirkt. Mithilfe eines speziellen Gummibandes wird das betroffene Körperareal kurzzeitig komprimiert und anschließend wieder entlastet. Dieser Prozess fördert die Durchblutung, löst Verklebungen im Gewebe und kann Schmerzen effektiv reduzieren.",
        ...
        cards: [
          {
            title: "FDM kezelés",
            text:
              "Az FDM egy modern manuális kezelési módszer, amely célzottan a fájdalmakra és a mozgáskorlátozottságokra hat a mozgásszervrendszerben.",
            price: "60 perc · 60 €",
            image: "/fdm.png",
          },
          {
            title: "Flossing",
            text:
              "A flossing egy modern fizioterápiás kezelés, amely célzottan hat a fasciákra, izmokra és ízületekre. Egy speciális gumiszalag segítségével a kezelt terület rövid ideig kompresszió alá kerül, majd tehermentesül.",
          ...
          },
          {
            title: "Köpölyözés",
            text:
              "A köpölyözés egy bevált módszer a vérkeringés serkentésére, a feszültségek oldására és az anyagcsere támogatására.",
            price: "30 perc · 30 €",
            image: "/cupping.png",
          },
        ],
      ...
      <section id="ueber" className="bg-[#f8f2e9] py-20">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-10">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 rounded-[2rem] bg-[#efe7da] p-8 shadow-sm">
              ...
              <div className="bg-[#f8f5ef] p-8 md:p-10">
                ...
                <div className="mt-6 rounded-2xl border border-[#cfd8bf] bg-[#edf4e3] p-5">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-4 inline-block rounded-full bg-[#6f7d58] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#5f6c4a]"
                  >
